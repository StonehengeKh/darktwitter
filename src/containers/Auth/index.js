...
export const Logo = () => {
  return (
    <svg
      ...
      viewBox="6.302518844604492 0 345.9733581542969 358.573974609375"
    >
      <path
        d="M349.392,188.25c-2.426-0.821-8.947-3.453-10.738-6.017c-0.285-0.407-0.728-1.284-1.289-2.394
  ...
  render() {
    ...
    return (
      <div className="wrapper">
        ...
        <Route
          render={() => (localStorage.authToken ? <Redirect to="/" /> : null)}
        />
      </div>
    );
  }
